...
local cart = {
	physical = false,
	collisionbox = {-0.55,-0.5,-0.55, 0.55,0.2-0.052,0.55},
	visual = "mesh",
	mesh = "cart.b3d",
	visual_size = {x=1, y=1},
	textures = {"cart.png"},
...
function cart:on_rightclick(clicker)
	...
	elseif not self.driver then
		self.driver = clicker
		clicker:set_attach(self.object, "", {x=0,y=0.453,z=-2}, {x=0,y=0,z=0})
...
minetest.register_craftitem("carts:cart", {
	...
	inventory_image = "cart_inv.png",
	wield_image = "cart_inv.png",
...
minetest.register_craft({
	...
	recipe = {
		{"tools:steel_ingot", "tools:gold_ingot", "tools:steel_ingot"},
...
minetest.register_craft({
	...
	recipe = {
		{"tools:steel_ingot", "ores:coal_lump", "tools:steel_ingot"},
		{"tools:steel_ingot", "tools:stick", "tools:steel_ingot"},
		{"tools:steel_ingot", "", "tools:steel_ingot"},
	}
})
