...
minetest.register_craft({
	...
	recipe = {
		{"farming:string", "tools:steel_ingot", ""},
		{"farming:string", "", "tools:steel_ingot"},
		{"farming:string", "tools:steel_ingot", ""},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{"farming:string", "tools:bronze_ingot", ""},
		{"farming:string", "", "tools:bronze_ingot"},
		{"farming:string", "tools:bronze_ingot", ""},
	}
})
...
minetest.register_craft({
	...
	recipe = {
		{"farming:string", "ores:mese_crystal", ""},
		{"farming:string", "", "ores:mese_crystal"},
		{"farming:string", "ores:mese_crystal", ""},
	}
})
